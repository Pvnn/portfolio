      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-5 flex flex-col items-center justify-center relative">
            <div className="relative w-full max-w-87.5 flex items-center justify-center">
              <Image src="/avatars/avatar.png" alt="About me illustration" width={350} height={350} className="w-full max-w-87.5 h-auto object-contain select-none" />
            </div>
          </div>
